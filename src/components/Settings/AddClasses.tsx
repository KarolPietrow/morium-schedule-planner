...
import { View, Text, TouchableOpacity, StyleSheet, TextInput, Keyboard, ActivityIndicator, FlatList } from 'react-native';
                        ...
                        {item.classes.map(cls => {
                            ...
                            return (
                                <View key={cls.id} style={[styles.classRow, { borderBottomColor: colors.border }]}>
                                    ...
                                    <TouchableOpacity
                                        style={[styles.actionButton, { backgroundColor: isSaved ? '#EF444420' : '#4F46E520' }]}
                                        onPress={() => {
                                            if (isSaved) {
                                                removeClass(cls.id);
                ...
                <>
                    ...
                    {isLoadingSchedules ? (
                        <View style={{ alignSelf: "center" }}>
                            ...
                            <Text style={{ color: colors.text }}>Łączenie z serwerami Moria...</Text>
                        </View>
                    ) : (
                        <FlatList
...
const styles = StyleSheet.create({
    ...
    listItem: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 16, borderRadius: 8, borderWidth: 1, marginBottom: 8 },
    selectedHeader: { flexDirection: 'row', alignItems: 'center', padding: 16, borderBottomWidth: 1 },
    ...
    classRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 16, borderBottomWidth: 1 },
